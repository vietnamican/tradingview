...
module.exports = class SystemBollinger {
    ...
    init() {
        ...
        this.buffer.indicators["TIENBOLLINGER"] = {};
    }
    ...
    start() {
        ...
        chart.onUpdate(() => { // When price changes
            ...
            if (this.isFirst) {
                ...
                this.buffer.chart.periods = this.chart.periods.slice(5);
                this.buffer.indicators['TIENBOLLINGER'].periods = this.indicators['TIENEMA'].periods.slice(5);
                this.backup();
            }
    ...
    restore() {
        if (fs.existsSync(this.resume_path)) {
            ...
            this.buffer.indicators['TIENBOLLINGER'].periods = data.buffer.indicators['TIENBOLLINGER'].periods
    ...
    backup() {
        ...
        data.buffer.indicators['TIENBOLLINGER'] = {}
        data.buffer.indicators['TIENBOLLINGER'].periods = this.buffer.indicators['TIENBOLLINGER'].periods
    ...
    takePosition() {
        const periods = this.buffer.chart.periods;
        const current_ema = this.buffer.indicators['TIENBOLLINGER'].periods[0];
