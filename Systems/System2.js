...
module.exports = class TradingSystem {
    ...
    constructor(exchange_str, exchange, symbol_str, timeframe_str, chart, indicators) {
        ...
        axios.get(`https://api-testnet.bybit.com/v5/market/instruments-info?category=linear&symbol=${this.symbol_str}`).then(res => {
            ...
            this.exist = false;
            console.log(`Not exist ${exchange_str}:${symbol_str}`);
        });
    }
    start() {
    ...
    longshot() {
        ...
        // Check long
        const long_ema_condition = e5 > e10 && e10 > e20 && e20 > e50 && e50 > e200;
        const long_rsi_condition = rsi > 65 && rsi > rsi_fast && rsi_fast > rsi_slow;
        ...
        const short_ema_condition = e5 < e10 && e10 < e20 && e20 < e50 && e50 < e200;
        const short_rsi_condition = rsi < 35 && rsi < rsi_fast && rsi_fast < rsi_slow;
    ...
    async buy() {
        ...
        // try{
        //     const order = this.exchange.createMarketBuyOrderWithCost(this.symbol_str, qty, params);
        //     this.qty = qty;
        //     this.price = price;
        // } catch(err) {
        //     console.log(err);
